...
def testImageSimilarity(channelno,testname):
    ...
    ImageValidate=ImgSimilar(Img,Image.open("python\\_RefNotAuthor1.jpeg"))
    print ImageValidate
...
def testImageBrick(channelno,testname):
    ...
    if (ImageValidate < 1.5):
        ...
        print "[Output:Authorised Channel]"
    PyVideo.SetParameter(c,'ChannelState','IDLE')
    PyVideo.StopMCChannel(c)
    PyVideo.CloseMCDriver()
