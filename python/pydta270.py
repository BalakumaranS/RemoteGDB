...
def TC_Barker_Verify(channelNo,testName,dtaChannelNo):
    ...
    for x in range(3):
		...
		dta_na_barker_image = dta_na_image[120:375,60:890]
...
def TC_MSO_Verify_Page1(channelNo,testName,dtaChannelNo = None):
    # exit from diag if pointing to
    ...
    for x in range(3):
        ...
        time.sleep(3)
        received_messages_page_image = cv2.imread(image_path,0)
        mso_image = received_messages_page_image[68:300,150:810]
        cv2.imwrite(cropped_image_path,mso_image)
...
def TC_MSO_Verify_Page2(channelNo,testName,dtaChannelNo = None):
    # exit from diag if pointing to
...
def TC_Code_Verify(channelNo,testName,dtaChannelNo = None):
    ...
    for x in range(3):
		...
		time.sleep(3)
		received_messages_page_image = cv2.imread(image_path,0)
		#code_image = received_messages_page_image[354:380,160:958]
		code_image = received_messages_page_image[345:365,160:958]
