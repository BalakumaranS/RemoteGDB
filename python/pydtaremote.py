...
class PyRemote(IrTekClient):
    ...
    def arrowDown(self, repeat = 10 , duration = 10):
        for x in range(0, repeat):
            #IrTekClient.send_cmd(self,IrTrtekClient.cmd_wrap(self,self.ir_codes_key0, duration))
            IrTekClient.send_cmd(self,IrTekClient.cmd_wrap(self,self.ir_codes.key0))
            time.sleep(0.2)
            #IrTekClient.send_cmd(self,IrTekClient.cmd_wrap(self,self.ir_codes.key0))
            #IrTekClient.send_cmd(self,IrTekClient.cmd_wrap(self,self.ir_codes.key0))
            #IrTekClient.send_cmd(self,IrTekClient.cmd_wrap(self,self.ir_codes.key0))
